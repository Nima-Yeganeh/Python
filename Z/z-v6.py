...
with open(file1_name, 'r') as file1:
    ...
    for line in file1:
        ...
        if line.strip() not in lines_in_file2:
            ...
            text_to_convert = org_text_to_convert
            ...
            text_to_convert_with_space = space_syntax + text_to_convert_with_space + space_syntax + org_text_to_convert
            ...
            # text_to_speech_fr_slow(org_text_to_convert, output_file)
